...
{
    public class UserExamGeneralInfosVM
    {
        public int Id { get; set; } // UserExamSession Id (Primary key)
    ...
    public class UserExamGeneralInfosPageVM
    {
        public string ExamSessionName { get; set; }
        public int PageIndex { get; set; }
        public int TotalItemsCount { get; set; }
        public List<UserExamGeneralInfosVM> UserExamsPage { get; set; }
    }
