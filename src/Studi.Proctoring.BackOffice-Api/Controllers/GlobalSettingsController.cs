...
namespace Studi.Proctoring.BackOffice_Api
{
    ...
    public class GlobalSettingsController : ControllerBase
    {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GlobalSettingVM), description: "successful operation")]
        [SwaggerResponse(statusCode: 400, type: typeof(string), description: "bad request")]
        public async virtual Task<IActionResult> UpdateValueOfMaxCheckImageSizeAsync(string newValue)
        {
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GlobalSettingVM), description: "successful operation")]
        [SwaggerResponse(statusCode: 400, type: typeof(string), description: "bad request")]
        public async virtual Task<IActionResult> UpdateValueOfMaxProctoringImageSizeAsync(string newValue)
        {
            // Retrieves email of the connected user via its token
            var userEmail = adminTokenService.GetUserLogin(HttpContext.User);
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GlobalSettingVM), description: "successful operation")]
        [SwaggerResponse(statusCode: 400, type: typeof(string), description: "bad request")]
        public async virtual Task<IActionResult> UpdateValueOfPasswordValidityDurationAsync(string newValue)
        {
            // Retrieves email of the connected user via its token
            var userEmail = adminTokenService.GetUserLogin(HttpContext.User);
        ...
        [SwaggerResponse(statusCode: 200, type: typeof(GlobalSettingVM), description: "successful operation")]
        [SwaggerResponse(statusCode: 400, type: typeof(string), description: "bad request")]
        public async virtual Task<IActionResult> UpdateValueOfProctoringImageIntervalAsync(string newValue)
        {
            // Retrieves email of the connected user via its token
            var userEmail = adminTokenService.GetUserLogin(HttpContext.User);
